...
documents (the Standard security handler, given the password). The full general reader
is roadmapped as v2.1 (structural parser, Epic #100) and v2.2 (text/image extraction). Editing existing PDFs lands at v3.0 as a
