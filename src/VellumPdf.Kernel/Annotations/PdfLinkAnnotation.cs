...
public sealed class PdfLinkAnnotation
{
    ...
    /// others clear), which ISO 19005-2 §6.5.3 requires of every non-Popup annotation for PDF/A
    ...
    internal PdfDictionary BuildDictionary(PdfIndirectReference? destPageRef)
    {
        ...
        var dict = new PdfDictionary()
            ...
            // Emit the annotation flags (default /F 4 = Print). ISO 19005-2 §6.5.3 requires the
