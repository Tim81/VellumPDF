...
public sealed class Code128Barcode : Barcode1D
{
    ...
    /// <summary>Creates a Code 128 barcode from its ASCII content.</summary>
    /// <param name="content">The text to encode. Must be ASCII (code points 0-127).</param>
    /// <exception cref="ArgumentException">A character in <paramref name="content"/> falls outside 0-127.</exception>
