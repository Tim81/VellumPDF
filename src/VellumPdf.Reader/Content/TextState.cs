...
/// <c>TD</c>, <c>Tm</c>, <c>T*</c>, and the two Table 107 text-showing operators that also move
/// to the next line, <c>'</c> and <c>"</c>, update them: <c>'</c> has the same effect as
/// <c>T*</c> followed by <c>Tj</c>, and <c>"</c> sets <c>Tw</c> and <c>Tc</c> and then behaves as
/// <c>'</c>. Not stacked; the interpreter owns exactly one live instance.
/// </summary>
