...
public sealed class Heading
{
    ...
    /// Raised from <see cref="Document.Save(System.IO.Stream)"/> and the other save overloads, not
    /// from this property, when a non-finite top edge puts this heading's bookmark, or the bookmark
    /// of a later <see cref="Heading"/>, at a non-finite position. The message says PDF does not
    /// support NaN or Infinity as a real number.
    /// </exception>
