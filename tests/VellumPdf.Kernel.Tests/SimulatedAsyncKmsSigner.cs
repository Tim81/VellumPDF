...
internal sealed class SimulatedAsyncKmsSigner : IExternalSigner
{
    ...
    public SimulatedAsyncKmsSigner(RSA rsa, TimeSpan delay = default, Action? beforeSign = null)
    {
        _rsa = rsa;
        _delay = delay;
    ...
    public SimulatedAsyncKmsSigner(ECDsa ecdsa, TimeSpan delay = default, Action? beforeSign = null)
    {
        _ecdsa = ecdsa;
        _delay = delay;
        _beforeSign = beforeSign;
